...
public class Constant {
	...
	public final static String IE_DRIVER_DIRECTORY = System.getProperty("user.dir") + "\\src\\test\\java\\drivers\\IEDriverServer.exe";
        ...
        public static final String BASE_URL = "https://atomationpratice.com";
        public static final String USER_DIRECTORY = System.getProperty("user.dir");
        public static final String OS_NAME = System.getProperty("os.name");
        public static final String DRIVERS_DIRECTORY = "//drivers//";
        public static final String DEFAULT_USERNAME = "info@wujames.com";
        public static final String DEFAULT_PASSWORD = "Manchester1";
